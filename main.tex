...
\begin{figure}[ht]
  ...
  \caption{Breakdown of top 1000 XGBoost features. Age is an important feature, while sex is not important.}
...
Our methodology attained a mean challenge metric score of 0.484 on the evaluation set.
Additionally, we attained a mean values for AUROC of 0.890, AUPRC of 0.390, accuracy of 0.251, overall $\text{F}_1$ score of 0.370, $\text{F}_\beta$ of 0.427, and $\text{G}_\beta$ measure of 0.222.
...
Using 100 repeated random sub-sampling of 85:15 train/evaluation, we trained models to evaluate feature importances to distill our input features to a set of 1,000 important features.
Using the reduced set of 1,000 features, we retrained our models and report our mean evaluation challenge score of 0.478.
