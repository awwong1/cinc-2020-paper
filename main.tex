...
A categorical visualization of our top 1,000 features, grouped by lead and feature type, is shown in Figure~\ref{fig:top_features}.
We see that heartbeat template features are particularly important, with emphasis on leads \texttt{aVR} and \texttt{V1}.

We present our metrics from the 15\% validation splits of the dataset in Figure~\ref{fig:classification_metrics_summary}.
Our methodology attains a mean challenge metric score of 0.484.
