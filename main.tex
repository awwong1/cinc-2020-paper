...
Our methodology generates an official phase validation set score of \officialvalscore and test set score of \officialtestscore under the team name, CVC, placing us 35 out of 40 in the rankings.
...
Our methodology achieves a challenge score of \officialvalscore on the official validation set and \officialtestscore for the official test set, ranking team CVC at 35 of 40 teams.
...
For our team, \emph{CVC}, the official phase challenge scores is \officialvalscore on the validation set and \officialtestscore on the test set.
We attain a rank of 35 of 40 qualifying teams.
